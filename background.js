...
function mediaList(){
  ...
  */
  ...
  mediaSources[0] = new Array ("nytimes.com", 0, .9, 1);
  mediaSources[1] = new Array ("theintercept.com", -.8, .9, 1);
  mediaSources[2] = new Array ("npr.org", -.2, .9, 1);
  mediaSources[3] = new Array ("wsj.com", .5, .9, 1);
  mediaSources[4] = new Array ("facebook.com", 0, 0, 3);
  mediaSources[5] = new Array ("twitter.com", 0, 0, 3);
  mediaSources[6] = new Array ("foxnews.com", .8, .3, 1);
  mediaSources[7] = new Array ("breitbart.com", .9, .1, 1);
  mediaSources[8] = new Array ("indypendent.org", -1, .7, 1);
  mediaSources[9] = new Array ("snopes.com", 0, 1, 2);
  mediaSources[10] = new Array ("theatlantic.com", -.7, .9, 1);
  mediaSources[11] = new Array ("washingtonpost.com", .1, .9, 1);
  ...
  mediaSources[22] = new Array ("the-daily-show-with-trevor-noah", -.8, .6, 1); //trigger only, no redirection. (would need to link to www.dailyshow.com)
  mediaSources[23] = new Array ("businessinsider.com", 0, .9, 1);
  mediaSources[24] = new Array ("theeconomist.com", 0, .9, 1);
  mediaSources[25] = new Array ("buzzfeed.com", -.2, .7, 1);
  mediaSources[26] = new Array ("rushlimbaugh.com", 1, .3, 1);
  ...
  mediaSources[32] = new Array ("theblaze.com", .8, .9, 1);
